...
public class Explosion {
    ...
    public static Group explosionAlien() {
        ...
        KeyFrame kf1 = new KeyFrame(Duration.millis(80) , actionEvent -> explosionAlien.getChildren().setAll(ex1));
        KeyFrame kf2 = new KeyFrame(Duration.millis(160), actionEvent -> explosionAlien.getChildren().setAll(ex2));
        KeyFrame kf3 = new KeyFrame(Duration.millis(240), actionEvent -> explosionAlien.getChildren().setAll(ex3));
        KeyFrame kf4 = new KeyFrame(Duration.millis(320), actionEvent -> explosionAlien.getChildren().setAll(ex4));
        KeyFrame kf5 = new KeyFrame(Duration.millis(400), actionEvent -> explosionAlien.getChildren().setAll(ex5));
        KeyFrame kf6 = new KeyFrame(Duration.millis(480), actionEvent -> explosionAlien.getChildren().setAll(ex6));
        KeyFrame kf7 = new KeyFrame(Duration.millis(560), actionEvent -> explosionAlien.getChildren().setAll(ex7));
        KeyFrame kf8 = new KeyFrame(Duration.millis(640), actionEvent -> explosionAlien.getChildren().setAll(ex8));
    ...
    public static Group explosionShip() {
        final ImageView ex1 = new ImageView(Images.SHIP_SHOOT_EX1);
        ex1.setFitWidth(50);
        ex1.setFitHeight(60);
        final ImageView ex2 = new ImageView(Images.SHIP_SHOOT_EX2);
        ex2.setFitWidth(50);
        ex2.setFitHeight(60);
        final ImageView ex3 = new ImageView(Images.SHIP_SHOOT_EX3);
        ex3.setFitWidth(50);
        ex3.setFitHeight(60);
        final ImageView ex4 = new ImageView(Images.SHIP_SHOOT_EX4);
        ex4.setFitWidth(50);
        ex4.setFitHeight(60);
        final ImageView ex5 = new ImageView(Images.SHIP_SHOOT_EX5);
        ex5.setFitWidth(50);
        ex5.setFitHeight(60);
        final ImageView ex6 = new ImageView(Images.SHIP_SHOOT_EX6);
        ex6.setFitWidth(50);
        ex6.setFitHeight(60);
        final ImageView ex7 = new ImageView(Images.SHIP_SHOOT_EX7);
        ex7.setFitWidth(50);
        ex7.setFitHeight(60);
        final ImageView ex8 = new ImageView(Images.SHIP_SHOOT_EX8);
        ex8.setFitWidth(50);
        ex8.setFitHeight(60);
        final ImageView ex9 = new ImageView(Images.SHIP_SHOOT_EX9);
        ex9.setFitWidth(50);
        ex9.setFitHeight(60);
        final ImageView ex10 = new ImageView(Images.SHIP_SHOOT_EX10);
        ex10.setFitWidth(50);
        ex10.setFitHeight(60);
        final ImageView ex11 = new ImageView(Images.SHIP_SHOOT_EX11);
        ex11.setFitWidth(50);
        ex11.setFitHeight(60);
        ...
        KeyFrame kf9 = new KeyFrame(Duration.millis(720), new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                explosionShip.getChildren().setAll(ex9);
            }
        });
        KeyFrame kf10 = new KeyFrame(Duration.millis(800), new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                explosionShip.getChildren().setAll(ex10);
            }
        });
        KeyFrame kf11 = new KeyFrame(Duration.millis(880), new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
